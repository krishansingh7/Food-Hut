                ...
                <div className=" relative ">
                  ...
                  <div className="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <p className="text-base text-gray-700">
                      At Crispy Bytes, we're not just about satisfying your
                      hunger; we're here to ignite your passion for flavor
                      exploration. Our web application brings together a diverse
                      array of restaurants, each offering their own unique
                      tastes and specialties, all within easy reach of your
                      fingertips.
                    </p>
